...
return [
    ...
    // 'adminUserCookieKey' => 'SpecialBaseAdminUser',
    'BaseAdminDomain' => 'http://test.base.nisiya.top',
    'AdminDomain' => 'http://test.admin.hospital.nisiya.top',

    'hospital_upload_dir' => "/data/upload/doctors/hospital/yaoqi",//医院上传图片目录
    ...
    'api_url' => [
        ...
        'news' => 'http://test.api.news.nisiya.top',
    ...
    'gh_jiankang160' => [
        'cid' => '100013323',
        'token' => 'fb89705ae6d743bf1e848c206e16a1d7',
    ],
    //陕西挂号相关
    'gh_shaanxi' => [
