...
class AgencyCreateForm extends MinDepartmentModel
{
    public function rules()
    {
        ...
        $current = [
            [
                [
                    'min_hospital_name','min_minying_fkname','min_minying_skname','miao_first_department_id','miao_second_department_id'
                ], 'required'
            ],
            [
                [
