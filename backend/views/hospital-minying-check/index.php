    ...
    <form class="layui-form" action="">
        ...
        <!--<div class="layui-form-item layui-inline">
            ...
            <div class="layui-input-block" style="width:100px;margin-left:100px;">
                <?php /*echo Html::dropDownList('hospital_level', $request->get('hospital_level') ?? '', $hospital_level, array('id' => 'tp_platform_list', "class" => "form-control input-sm")); */?>
            </div>
        </div>-->
        <div class="layui-form-item layui-inline">
    ...
    <table id="main-table" class="table table-hover" lay-even="true" style="overflow-x:scroll;">
        ...
        <?php if (!empty($dataProvider)): ?>
            <?php foreach ($dataProvider as $value): ?>
                <tr>
                    <td ><?php echo $value['min_hospital_id']; ?></td>
                    <td ><?php echo Html::encode($value['min_hospital_name']); ?></td>
                    <!--<td ><?php /*echo $hospital_level[$value['min_hospital_level']]; */?></td>-->
                    <td ><?php echo $value['create_time']; ?></td>
                    <td ><?php echo $value['first_check_name']; ?></td>
                    <td ><?php echo $value['first_check_time']; ?></td>
                    <td ><?php echo $value['second_check_name']; ?></td>
                    <td ><?php echo $value['second_check_time']; ?></td>
                    <td ><?php echo $check_list[$value['check_status']]; ?></td>
                    <td >
                        <a href="<?php echo Url::to(['hospital-minying-check/info','id'=>$value['min_hospital_id']])?>" title='详情'>
