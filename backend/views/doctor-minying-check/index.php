...
$this->title = '医生审核列表';
$hospital_level = MinHospitalModel::$levellist;
...
<div class="layui-row">
    <form class="layui-form" action="">
        <div class="layui-form-item layui-inline">
            <label class="layui-form-label" style="width:100px;">医生名称：</label>
            <div class="layui-input-block layui-inline" style="margin-left:0px;width:200px;">
                <input type="text" name="doctor_name"  placeholder="请输入医生名称" autocomplete="off" class="layui-input" value="<?php echo Html::encode($request->get('doctor_name', '')); ?>">
            </div>
        </div>
        <div class="layui-form-item layui-inline">
