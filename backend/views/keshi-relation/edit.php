...
<div class="layui-form">
    <?php
    $form = ActiveForm::begin(['action' =>'/keshi-relation/keshi-list', 'method'=>'get','options' =>['name'=>'form'],'id'=>'layer-form-table']);
    ?>
        ...
        <div class="layui-form-item layui-inline">
            ...
            <div class="layui-input-block layui-inline" style="margin-left:0px;width:280px;">
                ...
                <select name="hospital_id" lay-verify="required" lay-search lay-filter="hos" class="hos" id="hos">
                    ...
                    <option value="<?php echo $hospital['id']??'';?>" <?php if($hospital['id'] == ($requestParams['id']??0)){ echo 'selected="selected"'; }?>><?=isset($hos['id']) ? $hospital['id'].'-'. Html::encode($hospital['name']) : '';?></option>
                    <?php endif;?>
                </select>
            </div>
        </div>
...
<div>
    <?php echo GridView::widget([
            ...
            'pager'=>[
                ...
                'goFormActive' => Yii::$app->urlManager->createUrl(array_merge([Yii::$app->controller->id.'/keshi-list'],$params['requestParams'],['1'=>1])),
                'firstPageLabel' => '首页',
                'prevPageLabel' => '《',
                'nextPageLabel' => '》',
                'lastPageLabel' => '尾页',
            ...
            'columns' => [
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function ($model, $key, $index, $column) use($hospital){
                            $info = BaseDoctorHospitals::getHospitalDetail($model->hospital_id);
                            return isset($hospital['name'])? Html::encode($hospital['name']) : (isset($info['name']) ? Html::encode($info['name']) : '');
                    } 
                ],  
                [
                    'label' => '一级科室',
                    ...
                    'format' => 'html',
                    'value' => function ($model, $key, $index, $column) {
                        return Html::encode($model->frist_department_name);
                    }
                ],   
                 ...
                 [
                    ...
                    'format' => 'html',
                    'value' => function ($model, $key, $index, $column) {
                        return Html::encode($model->second_department_name);
                    }
                ],   
                ...
                [
                    ...
                    'value' => function ($model, $key, $index, $column) {
                        if ($model->miao_frist_department_id) {
                            return Html::encode(CommonFunc::getKeshiName($model->miao_frist_department_id));
                        }else{
                            return '--';
                        }
                    }
                 ...
                 [
                    ...
                    'value' => function ($model, $key, $index, $column) {
                        if ($model->miao_second_department_id) {
                            return Html::encode(CommonFunc::getKeshiName($model->miao_second_department_id));
                        }else{
                            return '--';
                        }
                    }
...
$(".recheck-open").click(function () {
    ...
    layer.open({
        ...
        yes: function (index, layero) {
            ...
            var address = $(layer.getChildFrame(".address", index)).val(); // 文本值
